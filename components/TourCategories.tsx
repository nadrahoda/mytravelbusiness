  ...
  return (
    <>
      <div className='text-center'>
        <p className='font-dancing-script text-teal-500 text-2xl'>
        ...
        <div className='flex w-full max-w-5xl items-end justify-center gap-4'>
          {currentItems.map((c, index) => (
            <Link
              ...
              href='#'
              className={`group relative flex w-[240px] md:w-[280px] lg:w-[320px] overflow-hidden rounded-[26px] bg-slate-100 ring-1 ring-black/5 transition-all duration-300 md:origin-bottom ${
                slotStyles[index] ?? ''
              }`}
            >
