...
import { FaMapMarkerAlt, FaClock, FaUser, FaChevronDown, FaArrowRight } from "react-icons/fa";
        ...
        <div className="mx-auto flex items-center justify-start px-4 py-0 gap-3">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="font-semibold text-lg md:text-lg text-white z-10">भ्रMan Sukh</span>
